...
public class Deadline : CwaffGun
{
    ...
    public static string LongDescription  = "Projectiles spawn lasers upon colliding with walls. If two of these lasers intersect, a large explosion is created at the point of intersection.";
