...
public class Suncaster : CwaffGun
{
    ...
    public static string LongDescription  = "Fires beams of sunlight. Reload to toss a refractive prism. Uncharged shots that hit a prism will refract towards all other prisms. Charged shots continuously refract off of all placed prisms for a short period. Prisms can be reclaimed by interacting with them or by entering a new room. Cannot gain ammo normally, but passively restores ammo over time.";
