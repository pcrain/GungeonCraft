...
public class RCLauncher : CwaffGun
{
    ...
    public static string LongDescription  = "Launches R.C. cars that explode on impact. Each car follows the car fired before it, or the mouse cursor / controller aim direction if it is the lead car. Reload time scales with the number of shots fired from the gun's clip.";
