...
public class Femtobyte : CwaffGun
{
    ...
    public static string LongDescription  = "Fires projectiles that can digitize chests, tables, barrels, consumables, and certain other objects. Reloading cycles through digital slots. If the current slot is full, firing the gun will place the selected digitized object at the reticle.";
