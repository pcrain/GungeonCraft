...
public class MacchiAuto : CwaffGun
{
    ...
    public static string LongDescription  = "Fires a stream of coffee that inflicts a stacking caffeinated status on enemies, increasing their speed but inflicting damage over time. Standing inside a pool of coffee slows down time for all objects other than the player.";
