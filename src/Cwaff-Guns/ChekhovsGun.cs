...
public class ChekhovsGun : CwaffGun
{
    ...
    public static string LongDescription  = "Places a rifle that automatically fires a single round at any enemy that crosses its line of sight. Rifles cannot fire within 3 seconds of placement. Half of all unfired shots are returned as ammo on room clear.";
    ...
    internal static CwaffTrailController _ChekhovTrailPrefab = null;
