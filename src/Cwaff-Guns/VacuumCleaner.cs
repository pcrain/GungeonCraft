...
public class VacuumCleaner : AdvancedGunBehavior
{
    ...
    public static void Add()
    {
        ...
        gun.InitProjectile(clipSize: -1, shootStyle: ShootStyle.Charged, ammoType: GameUIAmmoType.AmmoType.BEAM, chargeTime: float.MaxValue); // absurdly high charge value so we never actually shoot
