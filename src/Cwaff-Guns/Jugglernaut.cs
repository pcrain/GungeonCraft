...
public class Jugglernaut : CwaffGun
{
    ...
    public static string LongDescription  = "Fires projectiles whose damage scales with the number of unique enemies hit in a row. The juggling multiplier caps at 6 and resets upon switching guns or taking damage.";
