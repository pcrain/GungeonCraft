...
public class Kinsurrection : AdvancedGunBehavior
{
    ...
    {
        Gun gun = Lazy.SetupGun<Kinsurrection>(ItemName, SpriteName, ProjectileName, ShortDescription, LongDescription, Lore);
        ...
        Projectile projectile       = gun.InitFirstProjectile(new(damage: 30.0f, speed: 0.01f, force: 50.0f));
