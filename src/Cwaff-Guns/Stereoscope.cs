...
public class Stereoscope : CwaffGun
{
    ...
    public static string LongDescription  = "Continuously emits sound at a pitch corresponding to aim direction, and fires sonic waves which only damage enemies that resonate with the current pitch. Each enemy type resonates with a specific pitch. Enemies are stunned while resonating, and sonic waves deal extra damage when fired in time with Stereoscope's beat.";
