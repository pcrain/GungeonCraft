...
public class HatchlingGun : CwaffGun
{
    ...
    public static string Lore             = "The age-old question \"which came first, the chicken or the egg?\" is mostly of academic interest. Questions of more practical interest to gunsmiths include \"what is the fastest an egg can be fired out of a gun without it breaking in transit?\" and \"how much damage can a singular egg inflict on the Gundead?\" The answers to these questions turn out to be \"not very fast\" and \"not very much,\" respectively. As such, most gunsmiths have no interest in forging guns that fire eggs as projectiles, and the Hatchling Gun's existence can be largely attributed to an excessive supply of eggs moreso than an excessive demand of egg-shooting firearms.";
    ...
    public static void Init()
    {
        Lazy.SetupGun<HatchlingGun>(ItemName, ShortDescription, LongDescription, Lore)
          .SetAttributes(quality: ItemQuality.D, gunClass: GunClass.RIFLE, reloadTime: 1.25f, ammo: 500,
            shootFps: 40, reloadFps: 20, muzzleFrom: Items.Mailbox, smoothReload: 0.1f)
