...
public class Flakseed : CwaffGun
{
    ...
    public static string LongDescription  = "Fires flak seeds that grow into flak flowers after 3 seconds. Bullets pollinate flak sprouts they pass over, with stronger bullets causing faster growth. Grown flowers fire flak for 15 seconds before withering. Flowers will not wither while planted in water, and wither instantly when trampled or exposed to hostile terrain.";
    ...
    public static void Init()
    {
        Lazy.SetupGun<Flakseed>(ItemName, ShortDescription, LongDescription, Lore)
          ...
          .InitSpecialProjectile<GrenadeProjectile>(GunData.New(clipSize: 12, cooldown: 0.16f, preventOrbiting: true,
