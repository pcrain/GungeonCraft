...
public class Cleansweep : CwaffGun
{
    ...
    public static string LongDescription  = "First shot in every combat room deploys a Minesweeper grid for 10 ammo. Mines can be tripped by enemies, players, or Cleansweep's projectiles. Reloading with a full clip deploys a new grid for 20 ammo.";
