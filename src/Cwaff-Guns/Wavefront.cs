...
public class Wavefront : AdvancedGunBehavior
{
    ...
    public static void Add()
    {
        ...
        gun.InitProjectile(new(clipSize: 8, cooldown: 0.125f, shootStyle: ShootStyle.Automatic, range: 999999f, speed: 60f, shouldRotate: true,
          sprite: "wavefront_projectile_alt", scale: 0.25f, fps: 24, anchor: Anchor.MiddleCenter)
