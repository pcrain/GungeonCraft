...
public class Vladimir : CwaffGun
{
    ...
    public static string LongDescription  = "Impales nearby enemies. Impaled enemies are vulnerable to other enemies' projectiles and take damage from subsequent stabs. Each stab can destroy a single enemy projectile. Cannot be dropped or switched while an enemy is impaled. Increases curse by 1.";
