...
public class Tranquilizer : CwaffGun
{
    ...
    public static string LongDescription  = "Fires darts that permastun enemies after a few seconds. Each subsequent dart decreases an enemy's tranquilization timer by 3 seconds. Any enemy tranquilized while holding a gun has a 10% chance to drop their held gun and a 25% chance to drop a small ammo pickup.";
