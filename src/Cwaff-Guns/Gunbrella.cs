...
public class Gunbrella : CwaffGun
{
    ...
    public static void Init()
    {
        Lazy.SetupGun<Gunbrella>(ItemName, ShortDescription, LongDescription, Lore)
          ...
          .InitProjectile(GunData.New(clipSize: 1, shootStyle: ShootStyle.Charged, customClip: true, ammoCost: 1,
...
public class GunbrellaProjectile : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (!this._naturalSpawn)
        {
            ...
            ReadOnlyCollection<AIActor> enemies = this._owner.CenterPosition.GetAllNearbyEnemies();
