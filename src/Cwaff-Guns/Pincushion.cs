...
public class Pincushion : CwaffGun
{
    ...
    public static string LongDescription  = "Fires a barrage of pins that lose accuracy as the clip is depleted. Pins deal fixed damage, cannot damage anything other than enemies, and are blocked by decor such as barrels, crates, etc.";
