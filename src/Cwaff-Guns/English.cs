...
public class English : CwaffGun
{
    ...
    public static string LongDescription  = "Fires a cue ball towards a rack of billiard balls that grows as the gun is charged. Balls bounce off of walls, objects, and each other, dealing damage proportional to their velocity. Grounded balls can be reactivated by other balls. Increases curse by 1.";
