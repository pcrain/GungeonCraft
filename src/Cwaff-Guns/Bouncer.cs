...
public class Bouncer : CwaffGun
{
    ...
    public static string LongDescription  = "Fires slow but rapidly accelerating projectiles that phase through enemies and objects until bouncing. Each projectile's damage scales with its bounce speed. Projectiles bounce up to 3 times and create a small explosion upon their final impact.";
    ...
    public static void Init()
    {
        Lazy.SetupGun<Bouncer>(ItemName, ShortDescription, LongDescription, Lore)
          ...
          .InitProjectile(GunData.New(clipSize: 6, cooldown: 0.16f, shootStyle: ShootStyle.SemiAutomatic, damage: _ACCELERATION, speed: _ACCELERATION,
            range: 9999f, sprite: "energy_bounce", fps: 10, anchor: Anchor.MiddleCenter, customClip: true,
