...
public class ArmisticeDungeon
{
    ...
    public static Dungeon ArmisticeGeon(Dungeon dungeon)
    {
        ...
        Dungeon AbbeyDungeonPrefab = CwaffDungeons.GetOrLoadByName_Orig("Base_Cathedral");
        DungeonMaterial FinalScenario_MainMaterial = UnityEngine.Object.Instantiate(AbbeyDungeonPrefab.roomMaterialDefinitions[0]);
        ...
        m_FloorNameStampData.objectStamps = AbbeyDungeonPrefab.stampData.objectStamps;
        ...
        goheckyourself ??= AbbeyDungeonPrefab.tileIndices.dungeonCollection;
        dungeon.tileIndices = new TileIndices()
        {
            ...
            tilesetId = GlobalDungeonData.ValidTilesets.CATHEDRALGEON,
            ...
            dungeonCollection = AbbeyDungeonPrefab.tileIndices.dungeonCollection,
            dungeonCollectionSupportsDiagonalWalls = false,
            aoTileIndices = AbbeyDungeonPrefab.tileIndices.aoTileIndices,
            placeBorders = true,
            placePits = false,
            ...
            decalIndexGrid = null,
            patternIndexGrid = AbbeyDungeonPrefab.tileIndices.patternIndexGrid,
        ...
        AbbeyDungeonPrefab = null;

        return dungeon;
    }
}

public class ArmisticeDungeonFlow {
    ...
    public static DungeonFlow Init() {
        ...
        DungeonFlowNode BossRoomNode = new DungeonFlowNode(m_CachedFlow) {
            isSubchainStandin = false,
            nodeType = DungeonFlowNode.ControlNodeType.ROOM,
            roomCategory = PrototypeDungeonRoom.RoomCategory.CONNECTOR,
            percentChance = 1f,
            priority = DungeonFlowNode.NodePriority.MANDATORY,
            overrideExactRoom = ArmisticeBoss.ArmisticeBossRoom,
            overrideRoomTable = null,
            capSubchain = false,
            subchainIdentifier = string.Empty,
            limitedCopiesOfSubchain = false,
        ...
        m_CachedFlow.name = $"{ArmisticeDungeon.INTERNAL_NAME}_flow";
        ...
        m_CachedFlow.AddNodeToFlow(BossRoomNode, Node_00);
        m_CachedFlow.AddNodeToFlow(Node_99, BossRoomNode);
