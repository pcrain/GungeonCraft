...
public class PogoGun : CwaffGun
{
    ...
    public static string ShortDescription = "Shoot Mode";
    ...
    public static void Init() //NOTE: called in Rogo.cs, not Main.cs
    {
        Lazy.SetupGun<PogoGun>(ItemName, ShortDescription, LongDescription, Lore)
          .SetAttributes(quality: ItemQuality.EXCLUDED, gunClass: GunClass.RIFLE, reloadTime: 1.5f, ammo: 1000, infiniteAmmo: true, shootFps: 30,
            muzzleFrom: Items.Mailbox, fireAudio: "pogo_gun_shoot_sound", smoothReload: 0.1f, isStarterGun: true, undroppableStarter: true)
        ...
        gun.SetName(PogoStick.ItemName); // because canonically, they are the same item
    }
