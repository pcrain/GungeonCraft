...
public class PortableHydroTurret : CwaffGun
{
    ...
    public static void Init()
    {
        Lazy.SetupGun<PortableHydroTurret>(ItemName, ShortDescription, LongDescription, Lore)
          .SetAttributes(quality: ItemQuality.EXCLUDED, gunClass: GunClass.SHITTY, reloadTime: 1.0f, ammo: 100, shootFps: 30, smoothReload: 0.1f,
            infiniteAmmo: true, fireAudio: "portable_hydro_turret_fire_sound")
          .SetReloadAudio("portable_hydro_turret_reload_sound", 0, 2, 4, 6)
          .InitProjectile(GunData.New(sprite: "portable_hydro_turret_projectile", clipSize: 10, cooldown: 0.2f, shootStyle: ShootStyle.SemiAutomatic, customClip: false,
