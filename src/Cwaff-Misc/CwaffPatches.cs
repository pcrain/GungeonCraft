...
// Classes for harmony patches that need to be shared by multiple classes (e.g., functions that are patched multiple times)

/// <summary>Various helper functions for use in ILManipulators</summary>
