...
public static class CwaffHats
{
    public static void Init()
    {
      ...
      EasyHat(name: "bunny_hood",          offset: new Vector2( 0f/16f, -3f/16f));
      EasyHat(name: "jester_hat",          offset: new Vector2( 0f/16f, -3f/16f));
      EasyHat(name: "saiyan_hat",          offset: new Vector2( 0f/16f, -4f/16f));
      EasyHat(name: "wizard_hat",          offset: new Vector2(-1f/16f, -3f/16f));
      ...
      EasyHat(name: "admiral_hat",         offset: new Vector2( 0f/16f, -2f/16f));
      EasyHat(name: "apple",               offset: new Vector2( 0f/16f, -1f/16f));
      EasyHat(name: "blank_cap",           offset: new Vector2( 0f/16f, -1f/16f));
      EasyHat(name: "bullet_kin_hat",      offset: new Vector2( 0f/16f, -1f/16f));
      EasyHat(name: "german_general_hat",  offset: new Vector2( 0f/16f, -3f/16f));
      EasyHat(name: "kokiri_cap",          offset: new Vector2( 0f/16f, -3f/16f));
      EasyHat(name: "master_chief_helmet", offset: new Vector2( 0f/16f, -9f/16f));
      EasyHat(name: "mustache",            offset: new Vector2( 0f/16f, -6f/16f), onEyes: true);
      EasyHat(name: "number_2_headband",   offset: new Vector2( 0f/16f, -4f/16f));
      EasyHat(name: "pompom_hat",          offset: new Vector2(-1f/16f, -4f/16f));
      EasyHat(name: "spike_crown",         offset: new Vector2( 1f/16f, -1f/16f));
      EasyHat(name: "stovepipe",           offset: new Vector2( 0f/16f, -5f/16f));
      EasyHat(name: "u_s_a_general_hat",   offset: new Vector2( 0f/16f, -3f/16f));
