...
public class CustodiansBadge : CwaffPassive
{
    ...
    public static string LongDescription  = "Rewards extra shells for leaving decor unscathed after each combat encounter. Incurs one strike after letting more than 70% of decor in a room break. Disappears after incurring three strikes.";
