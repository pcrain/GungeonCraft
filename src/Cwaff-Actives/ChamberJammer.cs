...
public class ChamberJammer : PlayerItem
{
    ...
    public static string SpritePath       = "chamber_jammer_icon";
    ...
    {
        PlayerItem item = Lazy.SetupActive<ChamberJammer>(ItemName, SpritePath, ShortDescription, LongDescription, Lore);
