...
public class PogoStick : CwaffDodgeRollActiveItem
{
    ...
    public static string LongDescription  = "Rides or dismounts a pogo stick upon use. Holding the dodge roll button while riding the pogo stick charges a super bounce. Releasing the dodge roll button launches the player towards their current aim point as indicated by a targeting reticle. Landing on an enemy with a super bounce deals massive damage, triggers a mini blank effect, and rebounds the player towards their aim point with slightly reduced velocity. Grants an extra active item slot.";
