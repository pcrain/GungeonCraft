...
public class Frisbee : CwaffActive
{
    ...
    public static string Lore             = "A toy fit for children, dogs, and blobs of all ages. Its sturdy construction and inexplicable propensity for infinite flight open up all sorts of possibilities such as...well...maybe it'd be more fun to figure them out for yourself.";
