...
public class KalibersJustice : PlayerItem
{
    ...
    public static string SpritePath       = "kalibers_justice_icon";
    ...
    {
        PlayerItem item = Lazy.SetupActive<KalibersJustice>(ItemName, SpritePath, ShortDescription, LongDescription, Lore);
