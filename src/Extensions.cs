...
public static class Extensions
{
  ...
  /// <param name="undroppableStarter">If true, gun is undroppable as a starter item.</param>
  public static Gun SetAttributes(this Gun gun, ItemQuality quality, GunClass gunClass, float reloadTime, int ammo,
    ...
    bool isStarterGun = false, float percentSpeedWhileReloading = 1.0f, bool preventDuctTape = false, float muzzleEmissionSensitivity = 0.5f, bool preventVolleyModifications = false, bool undroppableStarter = false)
  {
    ...
    gun.StarterGunForAchievement = isStarterGun;
    gun.PreventStartingOwnerFromDropping = undroppableStarter;
    if (rampUpFireRate)
  ...
  public static BasicBeamController SetupBeamSprites(this Projectile projectile, string spriteName, int fps, int impactFps = -1,
    int endFps = -1, int startFps = -1, int chargeFps = -1, int dissipateFps = -1, int muzzleFps = -1, bool loopCharge = true)
  {
      ...
      BasicBeamController beamComp = projectile.FixedGenerateBeamPrefab(
          ...
          //Muzzle
          muzzleVFXAnimationPaths     : ResMap.Get($"{spriteName}_muzzle", quietFailure: true),
          beamMuzzleFPS               : (muzzleFps > 0) ? muzzleFps : fps,
          //Dissipate
  ...
  public static void Set(this CharacterSpecificGungeonFlags flag) => GameStatsManager.Instance.SetCharacterSpecificFlag(flag, true);

  /// <summary>Unset a character specific save flag.</summary>
  public static void Unset(this CharacterSpecificGungeonFlags flag) => GameStatsManager.Instance.SetCharacterSpecificFlag(flag, false);
