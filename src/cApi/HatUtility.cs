...
namespace Alexandria.cAPI
{
    public static class HatUtility
    {
        ...
        private static void AddHatAnimation(this tk2dSpriteAnimation animation, string animationName, List<string> spriteNames, int fps, tk2dSpriteCollectionData HatSpriteCollection,
